...
Now we can plot the results using the function `figureModelCurves()`, assuming the models start at zero. This function returns a **ggplot2** plot that can be saved or displayed directly. The function has several different options.

First, we can plot only the raw input data.
```{r plot raw data, echo=TRUE, fig.height=4, fig.width=6}
